...
#include "FORM_DICOLA_CSMemoria.h"
//---------------------------------------------------------------------------
...
void Concatenar(DiCola *Cola1, DiCola *Cola2, DiCola *Cola3)
{
	int E;
	DiCola *Aux = new DiCola(M);
